...
const SpecialOffer = () => {
  return (
    <div className="max-w-screen-xl mx-auto flexCenter w-full gap-20 bg-amber-50 rounded-[40px] my-20 relative">
      ...
      <div className="w-[40%] flexCol gap-4 justify-start items-start">
        ...
        <div className="flexCol gap-4">
          <h1 className="headingTwo text-gray-800 py-4">
