...
const SpecialOffer = () => {
  return (
    <div className="max-w-screen-xl mx-auto  w-full">
      <div className="flex sm:flex-col w-full xl:gap-20 sm:gap-12 bg-amber-50 xl:rounded-[40px] sm:rounded-[20px] my-20 relative sm:mx-4">
        ...
        <div className="">
          <img
            src={boy}
            alt=""
            className="xl:h-[600px] sm:h-[400px] xl:mt-[-60px] sm:mt-[-40px]"
          />
        </div>
